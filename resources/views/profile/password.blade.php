    ...
    <section class="content">
        <div class="card">
            ...
            <div class="card-body">
                <div>
                    <div>
                        <form class="form-horizontal" method="POST" action="{{ route('users.userPostPassword') }}">
                            @csrf
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" name="newpassword" id="newpassword"
                                            class="form-control @error('newpassword') is-invalid @enderror" value="" required
                                ...
                                <div class="col-12">
                                    <div class="form-group button">
                                        <button type="submit" class="btn btn-primary"><i class="fas fa-lock"></i> Change
                                            Password</button>
